          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            ...
            >
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/8 rounded-xl pl-9 pr-4 py-2 text-sm text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-blue-500/50 focus:bg-white/8 transition-all"
              />
            </div>
          </div>
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => onSearch(e.target.value)}
                  className="w-full bg-white/5 border border-white/8 rounded-xl pl-9 pr-4 py-2.5 text-sm text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-blue-500/50"
                />
              </div>
              {['home', 'products'].map((page) => (
                <button
                  ...
                  className={`block w-full text-left px-4 py-2.5 rounded-lg text-sm font-medium transition-all capitalize ${
                    currentPage === page
                      ? 'text-white bg-white/8'
                      : 'text-zinc-400 hover:text-white hover:bg-white/5'
                  }`}
